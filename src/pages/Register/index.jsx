  ...
  return (
    <div className="flex items-center flex-col pb-96">
      <div className=" shadow-lg shadow-black w-[498px] p-8 bg-[#fff] rounded-[20px]">
        <h2 className="pl-[150px] text-4xl text-black font-bold	 mb-10">Let’s go!</h2>
        <form onSubmit={handleSubmit}>
          ...
          <h2
            className="pl-[380px] pb-2 text-[#FC4747] cursor-pointer"
          ...
          <button
            type="submit"
            className="rounded-lg py-4 px-24 text-sm text-white bg-[#FC4747] mb-6 w-full"
            disabled={isLoading}
          >
